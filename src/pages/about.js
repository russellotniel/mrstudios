...
import {SiPuma, SiNike, SiAdidas, SiBata, SiNewbalance, SiJordan} from "react-icons/si"
    ...
    <Wrapper>
        ...
        {/* Title */}
            ...
            /> */}
                ...
                <div>
                  <p>Here at M.R Studios, we realize that style and prosperity begin with the correct shoes. We likewise understand that effectively finding the size and style to meet your requirements is vital to your web-based shopping knowledge. Since beginning our web-based business website in 2009, we’ve been endeavoring to present to you that perfect shopping experience.
                  </p>
                  ...
                  <div className="pt-5 text-center">
                    <div className="row">
                      <div className="col-sm">
                        ...
                        <p>Consistency is important to the overall success of every business. Providing consistent, high quality products allows your customers to know exactly what to expect every time they purchase your products.</p>
                      </div>

                      <div className="col-sm">
                        <h2>Competitive Production Rates</h2>
                        <p>Competitive pricing is the process of selecting strategic price points to best take advantage of a product or service based market relative to competition.</p>
                      </div>

                      <div className="col-sm">
                        <h2>Low Costs</h2>
                        <p>A pricing strategy in which a company offers a relatively low price to stimulate demand and gain market share.</p>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-sm">
                        ...
                        <p>A good company needs a reliable source of distribution, so that the product they sell can reach the customers in efficient time.</p>
                      </div>

                      <div className="col-sm">
                        <h2>Customer Satisfaction</h2>
                        <p>Customer satisfaction is defined as a measurement that determines how happy customers are with a company's products, services, and capabilities.</p>
                      </div>

                      <div className="col-sm">
                        <h2>To Provide Comfort</h2>
                        <p>We strive not only to be the greatest shoe company, but also to provide comfort to our customers when they buy from our company.</p>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section className="pt-4">
                    ...
                    <div className="d-flex text-center fs-1 d-flex justify-content-between pt-5">
                        ...
                        <div>
                            <div className="fs-4 d-flex justify-content-between flex-fill ps-4">Jordan</div>
                            <SiJordan></SiJordan>
                        </div>
                        <div>
                        ...
                        <div>
                            <div className="fs-4 d-flex justify-content-between flex-fill pr-4">New Balance</div>
